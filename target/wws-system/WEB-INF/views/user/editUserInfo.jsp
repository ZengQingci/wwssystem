...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="userName" id="userName" lay-verify="required" value="${userInfo.userName}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">邮箱</label>
        <div class="layui-input-inline">
            <input type="text" name="email" id="email" lay-verify="email" value="${userInfo.email}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">电话号码</label>
        <div class="layui-input-inline">
            <input type="text" name="phone" id="phone" lay-verify="required|phone" value="${userInfo.phone}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="state">
                <option value="0" ${userInfo.state==0?'selected':''}>禁用</option>
                <option value="1" ${userInfo.state==1?'selected':''}>启用</option>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <input type="hidden" id="isid" value="${userInfo.id}"/>
</form>
...
<script type="text/javascript">
    ...
    //图片的回显
    var img = "${userInfo.pic}";
    if(img){
        $("#demo1").attr("src","/image/"+img);
    }
</script>
</body>
</html>
